...
indexing, seeking and rendering. No `exiftool` subprocess, no C++ toolchain, no
system libraries.

| Crate                             |         |                                                                                    |
| --------------------------------- | ------- | ---------------------------------------------------------------------------------- |
| [`csq`](crates/csq)               | library | the FFF container parser, the JPEG-LS decoder and the radiometric model            |
